...
Route::controller(PageController::class)->group(function () {
    ...
    Route::get('/services/{service}', [PageController::class, 'showServices'])->name('services.show');
    Route::get('/portfolio/{title}', [PageController::class, 'show'])->name('portfolio.show');
