...
@section('content')
    ...
    <div class="table-container overflow-hidden">
        <table class="w-full">
            <thead class="table-header">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-medium text-white/50 uppercase tracking-wider">Request Type
                    </th>
        ...
        {{ $message->request_type === 'service' ? 'bg-blue-500/20 text-blue-400' : 'bg-purple-500/20 text-purple-400' }}">
                                {{ ucfirst($message->request_type) }}
                            </span>
                        </td>
