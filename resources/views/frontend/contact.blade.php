                    ...
                    <div class="glass rounded-2xl p-8">
                        ...
                        <form method="POST" action="{{ route('contact.send') }}" class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label
                                    class="cursor-pointer flex items-center justify-center px-4 py-3 rounded-xl
                                        border border-white/10 bg-white/5 text-white/70
                                        hover:text-white hover:border-primary-500 transition-all">
                                    <input type="radio" name="request_type" value="service"
                                        class="hidden peer"
                                        {{ old('request_type') === 'service' ? 'checked' : '' }}>
                                    <span class="peer-checked:text-primary-400 peer-checked:font-semibold">
                                        Harga Jasa
                                    </span>
                                </label>
                                ...
                                <label
                                    class="cursor-pointer flex items-center justify-center px-4 py-3 rounded-xl
                                        border border-white/10 bg-white/5 text-white/70
                                        hover:text-white hover:border-primary-500 transition-all">
                                    <input type="radio" name="request_type" value="product"
                                        class="hidden peer"
                                        {{ old('request_type') === 'product' ? 'checked' : '' }}>
                                    <span class="peer-checked:text-primary-400 peer-checked:font-semibold">
                                        Harga Produk
                                    </span>
                                </label>
