            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($portfolios as $index => $portfolio)
                    <div x-show="activeCategory === 'all' || activeCategory === '{{ $portfolio->category }}'"
                        ...
                        <a href="{{ route('portfolio.show', urlencode($portfolio->title)) }}"
                         class="block glass rounded-2xl overflow-hidden hover-lift">
                            <div class="relative overflow-hidden">
                                ...
                                @if($portfolio->project_url)
                                    <div
                                        ...
                                        <button
                                            onclick="event.stopPropagation(); window.open('{{ $portfolio->project_url }}', '_blank')"
                                            class="px-6 py-2 rounded-full gradient-primary text-white text-sm font-medium
