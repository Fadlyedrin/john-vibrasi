...
<body class="min-h-screen flex flex-col overflow-x-hidden" style="background-color: #0f0f23;">
            ...
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('products') }}"
                        class="text-white/80 hover:text-white transition-colors{{ request()->routeIs('products*') ? 'text-white font-medium' : '' }}">Products</a>
    ...
    <div x-data="{ show: true }" x-show="show" x-transition class="fixed bottom-5 right-5 z-50">
        <a href="https://wa.me/6281234567890" target="_blank"
            class="fixed bottom-5 right-5 z-50 w-14 h-14 flex items-center justify-center rounded-full bg-green-500 hover:bg-green-600 shadow-lg transition">

            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#ffffff" class="w-7 h-7">
                <path
                    d="M16.01 2.003c-7.732 0-14.01 6.278-14.01 14.01 0 2.73.786 5.396 2.273 7.697L2 30l6.44-2.11a13.95 13.95 0 0 0 7.57 2.17h.01c7.73 0 14.01-6.28 14.01-14.01 0-3.74-1.46-7.26-4.1-9.9-2.64-2.64-6.16-4.1-9.91-4.1zm0 25.31c-2.3 0-4.56-.62-6.53-1.8l-.47-.28-3.82 1.25 1.27-3.72-.3-.48a11.27 11.27 0 0 1-1.77-6.1c0-6.2 5.05-11.25 11.25-11.25 3 0 5.82 1.17 7.94 3.29a11.19 11.19 0 0 1 3.3 7.95c0 6.2-5.05 11.25-11.25 11.25zm6.17-8.46c-.34-.17-2.01-.99-2.32-1.1-.31-.11-.54-.17-.77.17-.23.34-.88 1.1-1.08 1.33-.2.23-.4.26-.74.09-.34-.17-1.44-.53-2.74-1.69-1.01-.9-1.69-2.01-1.89-2.35-.2-.34-.02-.53.15-.7.15-.15.34-.4.51-.6.17-.2.23-.34.34-.57.11-.23.06-.43-.03-.6-.09-.17-.77-1.86-1.05-2.55-.28-.67-.56-.58-.77-.59l-.66-.01c-.23 0-.6.09-.91.43-.31.34-1.2 1.17-1.2 2.86s1.23 3.32 1.4 3.55c.17.23 2.42 3.7 5.87 5.19.82.36 1.46.57 1.96.73.82.26 1.56.22 2.14.13.65-.1 2.01-.82 2.29-1.61.28-.79.28-1.46.2-1.61-.08-.15-.31-.23-.65-.4z" />
            </svg>
        </a>
