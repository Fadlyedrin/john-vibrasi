...
class PageController extends Controller
{
    ...
    public function sendMessage(Request $request)
    {
        $validated = $request->validate([
            ...
            'request_type' => 'required|in:service,product',
    ...
    public function showProduct(Product $product)
    {
        ...
        return view('frontend.show_product', $data);
    }
    // public function show($title)
    // {
    //     $portfolio = Portfolio::where('title', urldecode($title))->firstOrFail();

    //     $data = array_merge($this->getCommonData(), [
    //         'portfolio' => $portfolio,
    //     ]);

    //     return view('frontend.show_portfolio', $data);
    // }
    ...
    public function showServices(Service $service)
    {
        ...
        return view('frontend.show_services', $data);
    }
}
